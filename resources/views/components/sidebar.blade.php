        ...
        <ul class="sidebar-menu">
            ...
            <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu">
                    ...
                    <li>
                        <a class="nav-link" href="{{ route('products.index') }}"><i class="fa fa-shopping-basket"
            ...
            {{-- <li class="nav-item dropdown">
                <a href="#" class="nav-link has-dropdown"><i class="fa fa-calendar"
                        aria-hidden="true"></i><span>Transaction</span></a>
                <ul class="dropdown-menu">
                    <li class='{{ Request::is('home') ? 'active' : '' }}'>
                        <a class="nav-link" href="{{ url('reports') }}"><i
